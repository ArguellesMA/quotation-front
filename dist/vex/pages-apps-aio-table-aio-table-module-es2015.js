...
/*!*************************************************************!*\
  !*** ./src/app/pages/apps/aio-table/aio-table.component.ts ***!
  \*************************************************************/
/*! exports provided: AioTableComponent, CustomerDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _shared_services_client_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../../shared/services/client.service */ "./src/app/shared/services/client.service.ts");
...
/* harmony import */ var src_app_shared_models_client__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! src/app/shared/models/client */ "./src/app/shared/models/client.ts");
/* harmony import */ var _customer_create_update_customer_create_update_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./customer-create-update/customer-create-update.component */ "./src/app/pages/apps/aio-table/customer-create-update/customer-create-update.component.ts");
...
let AioTableComponent = class AioTableComponent {
    constructor(dialog, customersService, afs, storageService) {
        this.dialog = dialog;
        this.customersService = customersService;
        this.afs = afs;
        this.storageService = storageService;
        this.customer = new src_app_shared_models_client__WEBPACK_IMPORTED_MODULE_26__["Client"];
        ...
        this.rowData = [];
        this.dataSource = new CustomerDataSource(this.customersService);
  ...
  */
    ...
    createCustomer() {
        this.dialog.open(_customer_create_update_customer_create_update_component__WEBPACK_IMPORTED_MODULE_27__["CustomerCreateUpdateComponent"]).afterClosed().subscribe((addestablishment) => {
            if (addestablishment) {
    ...
    updateCustomer(i) {
        ...
        this.dialog.open(_customer_create_update_customer_create_update_component__WEBPACK_IMPORTED_MODULE_27__["CustomerCreateUpdateComponent"], {
            data: i
        }).afterClosed().subscribe(updatedCustomer => {
            if (updatedCustomer) {
                const index = this.customers.findIndex((existingCustomer) => existingCustomer.id === updatedCustomer.id);
                this.customers[index] = new src_app_shared_models_client__WEBPACK_IMPORTED_MODULE_26__["Client"]();
...
AioTableComponent.ctorParameters = () => [
    ...
    { type: _shared_services_client_service__WEBPACK_IMPORTED_MODULE_23__["ClientService"] },
...
class CustomerDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["DataSource"] {
...
/* harmony import */ var _shared_services_client_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../shared/services/client.service */ "./src/app/shared/services/client.service.ts");
/* harmony import */ var _shared_models_client__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../shared/models/client */ "./src/app/shared/models/client.ts");
...
let CustomerCreateUpdateComponent = CustomerCreateUpdateComponent_1 = class CustomerCreateUpdateComponent {
    constructor(defaults, dialogRef, fb, firestore, storageService, customersService) {
        ...
        this.storageService = storageService;
        this.customersService = customersService;
        this.clienteWeb = new _shared_models_client__WEBPACK_IMPORTED_MODULE_15__["Client"]();
        this.loading = false;
        this.mode = 'create';
...
CustomerCreateUpdateComponent.ctorParameters = () => [
    ...
    { type: _shared_services_client_service__WEBPACK_IMPORTED_MODULE_14__["ClientService"] }
];

...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrecioCreateUpdateComponent", function() { return PrecioCreateUpdateComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _interfaces_precio_model__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../interfaces/precio.model */ "./src/app/pages/apps/precio/interfaces/precio.model.ts");
/* harmony import */ var _shared_services_priceList_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../shared/services/priceList.service */ "./src/app/shared/services/priceList.service.ts");
/* harmony import */ var _shared_models_priceList__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../../shared/models/priceList */ "./src/app/shared/models/priceList.ts");
...
/* harmony import */ var _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../../shared/services/storage/storage.service */ "./src/app/shared/services/storage/storage.service.ts");
...
let PrecioCreateUpdateComponent = PrecioCreateUpdateComponent_1 = class PrecioCreateUpdateComponent {
    constructor(defaults, dialogRef, fb, firestore, storageService, priceListaService) {
...
PrecioCreateUpdateComponent.ctorParameters = () => [
...
PrecioCreateUpdateComponent = PrecioCreateUpdateComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'vex-precio-create-update',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./precio-create-update.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/precio/precio-create-update/precio-create-update.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./precio-create-update.component.scss */ "./src/app/pages/apps/precio/precio-create-update/precio-create-update.component.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrecioCreateUpdateModule", function() { return PrecioCreateUpdateModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _precio_create_update_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./precio-create-update.component */ "./src/app/pages/apps/precio/precio-create-update/precio-create-update.component.ts");
...
let PrecioCreateUpdateModule = class PrecioCreateUpdateModule {
};
PrecioCreateUpdateModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrecioRoutingModule", function() { return PrecioRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _precio_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./precio.component */ "./src/app/pages/apps/precio/precio.component.ts");
...
let PrecioRoutingModule = class PrecioRoutingModule {
};
PrecioRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PriceListDataSource", function() { return PriceListDataSource; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../../shared/services/storage/storage.service */ "./src/app/shared/services/storage/storage.service.ts");
/* harmony import */ var src_app_shared_models_priceList__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! src/app/shared/models/priceList */ "./src/app/shared/models/priceList.ts");
/* harmony import */ var src_app_shared_services_priceList_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! src/app/shared/services/priceList.service */ "./src/app/shared/services/priceList.service.ts");
/* harmony import */ var _precio_create_update_precio_create_update_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./precio-create-update/precio-create-update.component */ "./src/app/pages/apps/precio/precio-create-update/precio-create-update.component.ts");
...
//import { Precio } from './interfaces/precio.model';


let PrecioComponent = class PrecioComponent {
    constructor(dialog, priceListaService, afs, storageService) {
        this.dialog = dialog;
        this.priceListaService = priceListaService;
        this.afs = afs;
        this.storageService = storageService;
    ...
    ngOnInit() {
        ...
        this.dataSource.connect().subscribe(precios => {
            this.subject$.next(JSON.parse(JSON.stringify(precios)));
            this.items = precios;
        });
        //this.dataSource.getAllMarketing();
        //this.dataSource = new MatTableDataSource();
        this.data$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(Boolean)).subscribe(precios => {
            this.precios = precios;
            this.dataSource.connect().toPromise = precios;
        });
    ...
    createPrecio() {
        this.dialog.open(_precio_create_update_precio_create_update_component__WEBPACK_IMPORTED_MODULE_27__["PrecioCreateUpdateComponent"]).afterClosed().subscribe((preciList) => {
            if (preciList) {
    ...
    updatePrecio(i) {
        ...
        this.dialog.open(_precio_create_update_precio_create_update_component__WEBPACK_IMPORTED_MODULE_27__["PrecioCreateUpdateComponent"], {
            data: i
        }).afterClosed().subscribe(updatedPrecio => {
            if (updatedPrecio) {
                const index = this.precios.findIndex((existingPrecio) => existingPrecio.id === updatedPrecio.id);
                this.precios[index] = new src_app_shared_models_priceList__WEBPACK_IMPORTED_MODULE_25__["PriceList"]();
    ...
    removeAt(i) {
        ...
        this.precios.splice(this.precios.findIndex((existingPrecio) => existingPrecio.id === i.id), 1);
    ...
    onLabelChange(change, row) {
        const index = this.precios.findIndex(c => c === row);
...
PrecioComponent.ctorParameters = () => [
...
PrecioComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'precio',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./precio.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/precio/precio.component.html")).default,
        animations: [
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./precio.component.scss */ "./src/app/pages/apps/precio/precio.component.scss")).default]
    })
], PrecioComponent);

class PriceListDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["DataSource"] {
    constructor(priceListaService) {
        super();
        this.priceListaService = priceListaService;
    }
    /*getAllMarketing() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrecioModule", function() { return PrecioModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var src_vex_directives_container_container_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/@vex/directives/container/container.module */ "./src/@vex/directives/container/container.module.ts");
/* harmony import */ var src_vex_pipes_color_color_fade_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/@vex/pipes/color/color-fade.module */ "./src/@vex/pipes/color/color-fade.module.ts");
/* harmony import */ var _precio_routing_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./precio-routing.module */ "./src/app/pages/apps/precio/precio-routing.module.ts");
/* harmony import */ var _precio_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./precio.component */ "./src/app/pages/apps/precio/precio.component.ts");
/* harmony import */ var _precio_create_update_precio_create_update_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./precio-create-update/precio-create-update.module */ "./src/app/pages/apps/precio/precio-create-update/precio-create-update.module.ts");
...
let PrecioModule = class PrecioModule {
};
PrecioModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_precio_component__WEBPACK_IMPORTED_MODULE_12__["PrecioComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _precio_routing_module__WEBPACK_IMPORTED_MODULE_11__["PrecioRoutingModule"],
            ...
            _precio_create_update_precio_create_update_module__WEBPACK_IMPORTED_MODULE_13__["PrecioCreateUpdateModule"],
            ...
            src_vex_directives_container_container_module__WEBPACK_IMPORTED_MODULE_9__["ContainerModule"],
...
//# sourceMappingURL=pages-apps-precio-precio-module-es2015.js.map
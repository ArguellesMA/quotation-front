...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-apps-cotizacion-cotizacion-module"], {
  /***/
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.html":
  /*!**************************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.html ***!
    \**************************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesAppsCotizacionAddCotizacionAddCotizacionComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<!--<form (ngSubmit)=\"save()\" [formGroup]=\"form\">-->\n  <form class=\"needs-validation\" [formGroup]=\"form\" novalidate (ngSubmit)=\"save(form.value)\">\n    <div fxLayout=\"row\" fxLayoutAlign=\"start center\" mat-dialog-title>\n      \n  \n      <h2 *ngIf=\"form.get('folioCotizacion').value || form.get('cliente').value\"\n          class=\"headline m-0\"\n          fxFlex=\"auto\">{{ form.get('folioCotizacion').value + ' ' + form.get('cliente').value }}</h2>\n      <h2 *ngIf=\"!form.get('folioCotizacion').value && !form.get('cliente').value\"\n          class=\"headline m-0\"\n          fxFlex=\"auto\">Nueva Cotización</h2>\n\n  \n      <button [matMenuTriggerFor]=\"settingsMenu\" class=\"text-secondary\" mat-icon-button type=\"button\">\n        <mat-icon [icIcon]=\"icMoreVert\"></mat-icon>\n      </button>\n  \n      <button class=\"text-secondary\" mat-dialog-close mat-icon-button type=\"button\">\n        <mat-icon [icIcon]=\"icClose\"></mat-icon>\n      </button>\n    </div>\n  \n    <mat-divider class=\"-mx-6 text-border\"></mat-divider>\n  \n    <mat-dialog-content fxLayout=\"column\">\n      <div class=\"flex flex-col sm:flex-row\">\n        <mat-form-field class=\"mt-6 flex-auto\">\n          <mat-label>Folio cotización</mat-label>\n          <!--<input cdkFocusInitial formControlName=\"firstName\" matInput>-->\n          <input cdkFocusInitial formControlName=\"folioCotizacion\" type=\"number\" class=\"form-control\" id=\"folioCotizacion\" name=\"folioCotizacion\" [(ngModel)]=\"addCotizacion.folioCotizacion\" matInput>\n  \n          <!--<mat-icon [icIcon]=\"icPerson\" class=\"mr-3\" matPrefix></mat-icon>-->\n        </mat-form-field>\n  \n        <mat-form-field class=\"sm:mt-6 sm:ml-6 flex-auto\">\n          <mat-label>Folio Factura</mat-label>\n          <!--<input cdkFocusInitial formControlName=\"lastName\" matInput>-->\n          <input  formControlName=\"folioFactura\" type=\"number\" class=\"form-control\" id=\"folioFactura\" name=\"folioFactura\" [(ngModel)]=\"addCotizacion.folioFactura\" matInput>\n  \n          <!--<mat-icon [icIcon]=\"icPerson\" class=\"mr-3\" matPrefix></mat-icon>-->\n        </mat-form-field>\n      </div>\n  \n      <mat-form-field class=\"flex-auto\">\n        <mat-label>Cliente</mat-label>\n        <!--<input formControlName=\"street\" matInput>-->\n        <input  formControlName=\"cliente\" type=\"text\" class=\"form-control\" id=\"cliente\" name=\"cliente\" [(ngModel)]=\"addCotizacion.cliente\" matInput>\n  \n        <!--<mat-icon [icIcon]=\"icEditLocation\" class=\"mr-3\" matPrefix></mat-icon>-->\n      </mat-form-field>\n  \n      <div class=\"flex flex-col sm:flex-row\">\n        <mat-form-field class=\"flex-auto\">\n          <mat-label>Importe</mat-label>\n          <!--<input formControlName=\"zipcode\" matInput>-->\n          <input  formControlName=\"importe\" type=\"text\" class=\"form-control\" id=\"importe\" name=\"importe\" [(ngModel)]=\"addCotizacion.importe\" matInput>\n  \n          <!--<mat-icon [icIcon]=\"icMyLocation\" class=\"mr-3\" matPrefix></mat-icon>-->\n        </mat-form-field>\n  \n        <mat-form-field class=\"sm:ml-6 flex-auto\">\n          <mat-label>Fecha de pago</mat-label>\n          <!--<input formControlName=\"dia\" matInput>-->\n          <input  formControlName=\"fechaPago\" type=\"text\" class=\"form-control\" id=\"fechaPago\" name=\"fechaPago\" [(ngModel)]=\"addCotizacion.fechaPago\" matInput>\n  \n          <!--<mat-icon [icIcon]=\"icPerson\" class=\"mr-3\" matPrefix></mat-icon>-->\n        </mat-form-field>\n      </div>\n\n      <mat-form-field>\n        <mat-label>Estatus</mat-label>\n        <mat-select  class=\"custon-select form-control\" name=\"selectedValue\" id=\"selectedValue\"  [(ngModel)]=\"selectedValue\" (change)=\"selectmyEstatus()\"\n        formControlName=\"estatus\" [ngClass]=\"{ 'is-invalid': submitted && f.estatus.errors }\">\n          <mat-option *ngFor=\"let type of status\" [value]=\"type.value\">{{type.viewValue}}</mat-option>\n        </mat-select>\n        <div *ngIf=\"submitted && f.estatus.errors\" class=\"invalid-feedback\">\n          <div *ngIf=\"f.estatus.errors.required\">estatus es requerido</div>\n      </div>\n      </mat-form-field>\n\n    </mat-dialog-content>\n  \n    <mat-dialog-actions align=\"end\">\n      <button mat-button mat-dialog-close type=\"button\">CANCELAR</button>\n      <button *ngIf=\"isCreateMode()\" color=\"primary\" mat-button type=\"submit\">CREAR CLIENTE</button>\n      <button *ngIf=\"isUpdateMode()\" color=\"primary\" mat-button type=\"submit\">ACTUALIZAR CLIENTE</button>\n    </mat-dialog-actions>\n  </form>\n  \n  <mat-menu #settingsMenu=\"matMenu\" xPosition=\"before\" yPosition=\"below\">\n    <button mat-menu-item>\n      <mat-icon [icIcon]=\"icPrint\"></mat-icon>\n      <span>Imprimir</span>\n    </button>\n  \n    <button mat-menu-item>\n      <mat-icon [icIcon]=\"icDownload\"></mat-icon>\n      <span>Exportar</span>\n    </button>\n  \n    <button mat-menu-item>\n      <mat-icon [icIcon]=\"icDelete\"></mat-icon>\n      <span>Borrar</span>\n    </button>\n  </mat-menu>\n  ";
    /***/
  },

  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/cotizacion.component.html":
  /*!*******************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/cotizacion.component.html ***!
    \*******************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesAppsCotizacionCotizacionComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.scss":
  /*!************************************************************************************!*\
    !*** ./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.scss ***!
    \************************************************************************************/
  ...
  /***/
  function srcAppPagesAppsCotizacionAddCotizacionAddCotizacionComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".example-panel-red.mat-select-panel {\n  background: rgba(255, 0, 0, 0.5);\n}\n\n.example-panel-orange.mat-select-panel {\n  background: #ff9900;\n}\n\n.example-panel-green.mat-select-panel {\n  background: rgba(0, 255, 76, 0.884);\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },

  /***/
  "./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.ts":
  /*!**********************************************************************************!*\
    !*** ./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.ts ***!
    \**********************************************************************************/
  ...
  /***/
  function srcAppPagesAppsCotizacionAddCotizacionAddCotizacionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../../../../shared/services/cotizacion.service */
    "./src/app/shared/services/cotizacion.service.ts");
    /* harmony import */


    var _shared_models_cotizacion_cotizacion__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ../../../../shared/models/cotizacion/cotizacion */
    "./src/app/shared/models/cotizacion/cotizacion.ts");
    /* harmony import */


    var _shared_models_cotizacion_estatus__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ../../../../shared/models/cotizacion/estatus */
    "./src/app/shared/models/cotizacion/estatus.ts");
    /* harmony import */
    ...
    var _shared_services_toast_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ../../../../shared/services/toast.service */
    "./src/app/shared/services/toast.service.ts"); //import { Customer } from '../interfaces/customer.model';


    var AddCotizacionComponent = /*#__PURE__*/function () {
      function AddCotizacionComponent(defaults, dialogRef, fb, firestore, storageService, cotizacionService, storage, http, toastService) {
        ...
        this.addCotizacion = new _shared_models_cotizacion_cotizacion__WEBPACK_IMPORTED_MODULE_15__["Cotizacion"]();
        this.loading = false;
        ...
        this.mode = 'create';
        this.myestatus = new _shared_models_cotizacion_estatus__WEBPACK_IMPORTED_MODULE_16__["Estatus"]();
        this.status = [{
          value: 1,
          viewValue: 'Vencidos'
        }, {
          value: 2,
          viewValue: 'Por vencer'
        }, {
          value: 3,
          viewValue: 'A tiempo'
        }];
      ...
      _createClass(AddCotizacionComponent, [{
        ...
        value: function createForm() {
          this.form = this.fb.group({
            folioCotizacion: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            folioFactura: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            cliente: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            importe: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            fechaPago: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            estatus: [undefined, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
          });
        }
      }, {
        key: "selectmyEstatus",
        value: function selectmyEstatus() {
          alert(this.selectedValue);
          var myestatus = new _shared_models_cotizacion_estatus__WEBPACK_IMPORTED_MODULE_16__["Estatus"]();
        ...
        key: "updateCustomers",
        value: function updateCustomers() {
          if (this.storageService.getSession("$key") != null) {
    ...
    AddCotizacionComponent.ctorParameters = function () {
      return [{
        ...
        type: _shared_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_14__["CotizacionService"]
      }, {
        ...
        type: _shared_services_toast_service__WEBPACK_IMPORTED_MODULE_21__["ToastService"]
      }];
    };
    ...
    AddCotizacionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.html"))["default"],
      encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewEncapsulation"].None,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-cotizacion.component.scss */
      "./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"]))], AddCotizacionComponent);
    /***/
  },

  /***/
  "./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.module.ts":
  /*!*******************************************************************************!*\
    !*** ./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.module.ts ***!
    \*******************************************************************************/

  /*! exports provided: AddCotizacionModule */

  /***/
  function srcAppPagesAppsCotizacionAddCotizacionAddCotizacionModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddCotizacionModule", function () {
      return AddCotizacionModule;
    });
    /* harmony import */
    ...
    var _add_cotizacion_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./add-cotizacion.component */
    "./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.ts");
    /* harmony import */
    ...
    var AddCotizacionModule = function AddCotizacionModule() {
      _classCallCheck(this, AddCotizacionModule);
    };

    AddCotizacionModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_8__["MatInputModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButtonModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_7__["MatIconModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_9__["MatRadioModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_10__["MatSelectModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_12__["MatMenuModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_13__["IconModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_14__["MatDividerModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"]],
      declarations: [_add_cotizacion_component__WEBPACK_IMPORTED_MODULE_11__["AddCotizacionComponent"]],
      entryComponents: [_add_cotizacion_component__WEBPACK_IMPORTED_MODULE_11__["AddCotizacionComponent"]],
      exports: [_add_cotizacion_component__WEBPACK_IMPORTED_MODULE_11__["AddCotizacionComponent"]]
    })], AddCotizacionModule);
    /***/
  },

  /***/
  "./src/app/pages/apps/cotizacion/cotizacion-routing.module.ts":
  /*!********************************************************************!*\
    !*** ./src/app/pages/apps/cotizacion/cotizacion-routing.module.ts ***!
    \********************************************************************/

  /*! exports provided: CotizacionRoutingModule */

  /***/
  function srcAppPagesAppsCotizacionCotizacionRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CotizacionRoutingModule", function () {
      return CotizacionRoutingModule;
    });
    /* harmony import */
    ...
    var _cotizacion_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./cotizacion.component */
    "./src/app/pages/apps/cotizacion/cotizacion.component.ts");
    ...
    var CotizacionRoutingModule = function CotizacionRoutingModule() {
      _classCallCheck(this, CotizacionRoutingModule);
    };

    CotizacionRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  "./src/app/pages/apps/cotizacion/cotizacion.component.scss":
  /*!*****************************************************************!*\
    !*** ./src/app/pages/apps/cotizacion/cotizacion.component.scss ***!
    \*****************************************************************/
  ...
  /***/
  function srcAppPagesAppsCotizacionCotizacionComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2FwcHMvY290aXphY2lvbi9jb3RpemFjaW9uLmNvbXBvbmVudC5zY3NzIn0= */";
    /***/
  },
  ...
  /*! exports provided: CotizacionComponent, CustomerDataSource */

  /***/
  function srcAppPagesAppsCotizacionCotizacionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CustomerDataSource", function () {
    ...
    var _iconify_icons_ic_twotone_folder__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! @iconify/icons-ic/twotone-folder */
    "./node_modules/@iconify/icons-ic/twotone-folder.js");
    /* harmony import */


    var _iconify_icons_ic_twotone_folder__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_folder__WEBPACK_IMPORTED_MODULE_13__);
    /* harmony import */
    ...
    var _iconify_icons_ic_twotone_phone__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! @iconify/icons-ic/twotone-phone */
    "./node_modules/@iconify/icons-ic/twotone-phone.js");
    /* harmony import */


    var _iconify_icons_ic_twotone_phone__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_phone__WEBPACK_IMPORTED_MODULE_19__);
    /* harmony import */


    var _iconify_icons_ic_twotone_mail__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! @iconify/icons-ic/twotone-mail */
    "./node_modules/@iconify/icons-ic/twotone-mail.js");
    /* harmony import */


    var _iconify_icons_ic_twotone_mail__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_mail__WEBPACK_IMPORTED_MODULE_20__);
    /* harmony import */


    var _iconify_icons_ic_twotone_map__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! @iconify/icons-ic/twotone-map */
    "./node_modules/@iconify/icons-ic/twotone-map.js");
    /* harmony import */


    var _iconify_icons_ic_twotone_map__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_map__WEBPACK_IMPORTED_MODULE_21__);
    /* harmony import */
    ...
    var _shared_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ../../../shared/services/cotizacion.service */
    "./src/app/shared/services/cotizacion.service.ts");
    /* harmony import */


    var _shared_models_cotizacion_cotizacion__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ../../../shared/models/cotizacion/cotizacion */
    "./src/app/shared/models/cotizacion/cotizacion.ts");
    /* harmony import */


    var _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ../../../shared/services/storage/storage.service */
    "./src/app/shared/services/storage/storage.service.ts");
    /* harmony import */


    var _add_cotizacion_add_cotizacion_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./add-cotizacion/add-cotizacion.component */
    "./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.component.ts");
    /* harmony import */


    var _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    ...
    var CotizacionComponent = /*#__PURE__*/function () {
      //clientService: any;
      function CotizacionComponent(dialog, cotizacionService, storageService) {
        _classCallCheck(this, CotizacionComponent);

        this.dialog = dialog;
        this.cotizacionService = cotizacionService;
        this.storageService = storageService;
        this.filmIcon = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_28__["faFilm"];
        this.circleIcon = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_28__["faCircle"];
        this.items = new _shared_models_cotizacion_cotizacion__WEBPACK_IMPORTED_MODULE_24__["Cotizacion"]();
        this.displayedColumns = ['folioCotizacion', 'folioFactura', 'cliente', 'importe', 'fechaPago', 'estatus', 'editar', 'borrar'];
        this.dataSource = new CustomerDataSource(this.cotizacionService);
        ...
        this.icFolder = _iconify_icons_ic_twotone_folder__WEBPACK_IMPORTED_MODULE_13___default.a;
        this.vencidos = 0;
        this.porVencer = 0;
        this.aTiempo = 0;

        _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_27__["library"].add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_28__["faCircle"]);
      }
      ...
      _createClass(CotizacionComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.dataSource.connect().subscribe(function (customers) {
            ...
            customers.forEach(function (node) {
              console.log(node.estatus);

              _this["switch"](node.estatus);
            });
          });
        ...
        key: "createCustomer",
        value: function createCustomer() {
          this.dialog.open(_add_cotizacion_add_cotizacion_component__WEBPACK_IMPORTED_MODULE_26__["AddCotizacionComponent"]).afterClosed().subscribe(function (units) {
            if (units) {//this.branchs.unshift(new AddEstablishment(addestablishment));
        ...
        value: function updateCustomer(i) {
          ...
          this.dialog.open(_add_cotizacion_add_cotizacion_component__WEBPACK_IMPORTED_MODULE_26__["AddCotizacionComponent"], {
            data: i
            ...
            if (updatedCustomer) {
              ...
              _this2.customers[index] = new _shared_models_cotizacion_cotizacion__WEBPACK_IMPORTED_MODULE_24__["Cotizacion"]();
        ...
        value: function removeAt(i) {
          ...
          this.customers.splice(this.customers.findIndex(function (existingCustomer) {
            return existingCustomer.id === i.id;
          }), 1);
        ...
        value: function onLabelChange(change, row) {
          var index = this.customers.findIndex(function (c) {
            return c === row;
          });
    ...
    CotizacionComponent.ctorParameters = function () {
      return [{
        ...
        type: _shared_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_23__["CotizacionService"]
      }, {
        type: _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_25__["StorageService"]
      }];
    };

    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_22__["ViewChild"])(_angular_material_paginator__WEBPACK_IMPORTED_MODULE_3__["MatPaginator"], {
      "static": true
    })], CotizacionComponent.prototype, "paginator", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_22__["ViewChild"])(_angular_material_sort__WEBPACK_IMPORTED_MODULE_4__["MatSort"], {
      "static": true
    })], CotizacionComponent.prototype, "sort", void 0);
    CotizacionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_22__["Component"])({
      selector: 'vex-cotizacion',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./cotizacion.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/cotizacion.component.html"))["default"],
      animations: [_vex_animations_fade_in_up_animation__WEBPACK_IMPORTED_MODULE_14__["fadeInUp400ms"], _vex_animations_stagger_animation__WEBPACK_IMPORTED_MODULE_16__["stagger40ms"]],
      providers: [{
      ...
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./cotizacion.component.scss */
      "./src/app/pages/apps/cotizacion/cotizacion.component.scss"))["default"]]
    })], CotizacionComponent);

    var CustomerDataSource = /*#__PURE__*/function (_angular_cdk_collecti) {
      _inherits(CustomerDataSource, _angular_cdk_collecti);

      var _super = _createSuper(CustomerDataSource);

      function CustomerDataSource(cotizacionService) {
        var _this4;

        _classCallCheck(this, CustomerDataSource);

        _this4 = _super.call(this);
        _this4.cotizacionService = cotizacionService;
        return _this4;
      }
      ...
      return CustomerDataSource;
    }(_angular_cdk_collections__WEBPACK_IMPORTED_MODULE_11__["DataSource"]);
    /***/

  },

  /***/
  "./src/app/pages/apps/cotizacion/cotizacion.module.ts":
  /*!************************************************************!*\
    !*** ./src/app/pages/apps/cotizacion/cotizacion.module.ts ***!
    \************************************************************/

  /*! exports provided: CotizacionModule */

  /***/
  function srcAppPagesAppsCotizacionCotizacionModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CotizacionModule", function () {
    ...
    var _cotizacion_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./cotizacion.component */
    "./src/app/pages/apps/cotizacion/cotizacion.component.ts");
    /* harmony import */


    var _cotizacion_routing_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./cotizacion-routing.module */
    "./src/app/pages/apps/cotizacion/cotizacion-routing.module.ts");
    /* harmony import */


    var _add_cotizacion_add_cotizacion_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./add-cotizacion/add-cotizacion.module */
    "./src/app/pages/apps/cotizacion/add-cotizacion/add-cotizacion.module.ts");
    /* harmony import */
    ...
    /*! @fortawesome/free-solid-svg-icons */
    "./node_modules/@fortawesome/free-solid-svg-icons/index.es.js"); //import { AlmacenCreateUpdateModule } from './almacen-create-update/almacen-create-update.module';


    var CotizacionModule = function CotizacionModule(library) {
      _classCallCheck(this, CotizacionModule);

      library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_25__["faCircle"]);
    };

    CotizacionModule.ctorParameters = function () {
      return [{
        type: _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_24__["FaIconLibrary"]
      }];
    };

    CotizacionModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_cotizacion_component__WEBPACK_IMPORTED_MODULE_20__["CotizacionComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _cotizacion_routing_module__WEBPACK_IMPORTED_MODULE_21__["CotizacionRoutingModule"], _vex_components_page_layout_page_layout_module__WEBPACK_IMPORTED_MODULE_3__["PageLayoutModule"], _angular_flex_layout__WEBPACK_IMPORTED_MODULE_4__["FlexLayoutModule"], _vex_components_breadcrumbs_breadcrumbs_module__WEBPACK_IMPORTED_MODULE_5__["BreadcrumbsModule"], //AlmacenCreateUpdateModule,
      _angular_material_paginator__WEBPACK_IMPORTED_MODULE_6__["MatPaginatorModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_8__["MatSortModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_9__["MatCheckboxModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_10__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_11__["MatButtonModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_12__["MatMenuModule"], _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_13__["IconModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["FormsModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_15__["MatTooltipModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["ReactiveFormsModule"], _vex_directives_container_container_module__WEBPACK_IMPORTED_MODULE_16__["ContainerModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_17__["MatSelectModule"], _vex_pipes_color_color_fade_module__WEBPACK_IMPORTED_MODULE_18__["ColorFadeModule"], _angular_material_button_toggle__WEBPACK_IMPORTED_MODULE_19__["MatButtonToggleModule"], _add_cotizacion_add_cotizacion_module__WEBPACK_IMPORTED_MODULE_22__["AddCotizacionModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_23__["MatDatepickerModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_24__["FontAwesomeModule"]]
    })], CotizacionModule);
    /***/
  },
  ...
  /***/
  function srcAppSharedModelsCotizacionCotizacionTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /*! exports provided: Estatus */

  /***/
  function srcAppSharedModelsCotizacionEstatusTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Estatus", function () {
      return Estatus;
    });
    /* harmony import */
    ...
    var Estatus = function Estatus() {
      _classCallCheck(this, Estatus);
    };
    /***/

  }
}]);
//# sourceMappingURL=pages-apps-cotizacion-cotizacion-module-es5.js.map
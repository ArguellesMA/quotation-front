...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'fa',
                loadChildren: () => Promise.all(/*! import() | icons-fa-icons-fa-module */[__webpack_require__.e("common"), __webpack_require__.e("icons-fa-icons-fa-module")]).then(__webpack_require__.bind(null, /*! ./icons-fa/icons-fa.module */ "./src/app/pages/ui/icons/icons-fa/icons-fa.module.ts")).then(m => m.IconsFaModule)
            }
        ]
    }
];

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-auth-login-login-module"], {
  ...
  function srcAppPagesPagesAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _iconify_icons_ic_twotone_visibility__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_visibility__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */
    ...
    var _iconify_icons_ic_twotone_visibility_off__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_visibility_off__WEBPACK_IMPORTED_MODULE_6__);
    /* harmony import */
    ...
    var _shared_services_users_users_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../../../shared/services/users/users.service */
    "./src/app/shared/services/users/users.service.ts");
    /* harmony import */


    var _shared_models_users_usersapi__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../../../shared/models/users/usersapi */
    "./src/app/shared/models/users/usersapi.ts");
    /* harmony import */


    var _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../../../../shared/services/storage/storage.service */
    "./src/app/shared/services/storage/storage.service.ts");

    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(router, fb, cd, snackbar, usersService, storageService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function send() {
          ...
          var mydata = new _shared_models_users_usersapi__WEBPACK_IMPORTED_MODULE_9__["UserApi"]();
          ...
          return this.usersService.postUsers(mydata).subscribe(function (data) {
            console.log("post users: " + data.accessToken);

            _this.storageService.setLocal("token", data.accessToken);

            _this.router.navigate(['/']);

            _this.snackbar.open('Lucky you! Looks like you didn\'t need a password or email address! For a real application we provide validators to prevent this. ;)', 'LOL THANKS', {
              duration: 10000
            });
          });
        }
    ...
    LoginComponent.ctorParameters = function () {
      return [{
        ...
        type: _shared_services_users_users_service__WEBPACK_IMPORTED_MODULE_8__["UsersService"]
      }, {
        type: _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_10__["StorageService"]
      }];
    };
  ...
  /***/
  function srcAppSharedModelsUsersUsersapiTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";

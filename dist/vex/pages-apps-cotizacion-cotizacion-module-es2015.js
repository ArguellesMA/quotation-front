...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.html":
/*!**********************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.html ***!
  \**********************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ("<!--<form (ngSubmit)=\"save()\" [formGroup]=\"form\">-->\r\n<form class=\"needs-validation\" #quotesForm=\"ngForm\" (ngSubmit)=\"save(quotesForm)\" [formGroup]=\"form\">\r\n  <div fxLayout=\"row\" fxLayoutAlign=\"start center\" mat-dialog-title>\r\n   <!-- <img *ngIf=\"form.get('imageSrc').value\" [src]=\"form.get('imageSrc').value\" class=\"avatar mr-5\">-->\r\n\r\n    <h2 *ngIf=\"form.get('producto').value || form.get('noCotizacion').value\"\r\n        class=\"headline m-0\"\r\n        fxFlex=\"auto\">{{ form.get('producto').value + ' ' + form.get('noCotizacion').value }}</h2>\r\n    <h2 *ngIf=\"!form.get('producto').value && !form.get('noCotizacion').value\"\r\n        class=\"headline m-0\"\r\n        fxFlex=\"auto\">Nueva Cotización</h2>\r\n\r\n    <button [matMenuTriggerFor]=\"settingsMenu\" class=\"text-secondary\" mat-icon-button type=\"button\">\r\n      <mat-icon [icIcon]=\"icMoreVert\"></mat-icon>\r\n    </button>\r\n\r\n    <button class=\"text-secondary\" mat-dialog-close mat-icon-button type=\"button\">\r\n      <mat-icon [icIcon]=\"icClose\"></mat-icon>\r\n    </button>\r\n  </div>\r\n\r\n  <mat-divider class=\"-mx-6 text-border\"></mat-divider>\r\n\r\n  <mat-dialog-content fxLayout=\"column\">\r\n    <div class=\"flex flex-col sm:flex-row\">\r\n      <mat-form-field class=\"mt-6 flex-auto\">\r\n        <mat-label>Cotización</mat-label>\r\n        <!--<input cdkFocusInitial formControlName=\"noCotizacion\" matInput>-->\r\n        <input cdkFocusInitial formControlName=\"noCotizacion\" type=\"number\" class=\"form-control\" id=\"noCotizacion\" name=\"noCotizacion\" [(ngModel)]=\"cotizaciones.noCotizacion\" matInput>\r\n\r\n        \r\n      </mat-form-field>\r\n\r\n      <mat-form-field class=\"sm:mt-6 sm:ml-6 flex-auto\">\r\n        <mat-label>Producto</mat-label>\r\n        <!--<input cdkFocusInitial formControlName=\"producto\" matInput>-->\r\n        <input cdkFocusInitial formControlName=\"producto\" type=\"text\" class=\"form-control\" id=\"producto\" name=\"producto\" [(ngModel)]=\"cotizaciones.producto\" matInput>\r\n\r\n        <mat-icon [icIcon]=\"\" class=\"mr-3\" matPrefix></mat-icon>\r\n      </mat-form-field>\r\n    </div>\r\n\r\n    <mat-form-field class=\"flex-auto\">\r\n      <mat-label>Precio</mat-label>\r\n      <!--<input formControlName=\"precio\" matInput>-->\r\n      <input cdkFocusInitial formControlName=\"precio\" type=\"number\" class=\"form-control\" id=\"precio\" name=\"precio\" [(ngModel)]=\"cotizaciones.precio\" matInput>\r\n\r\n      <mat-icon [icIcon]=\"\" class=\"mr-3\" matPrefix></mat-icon>\r\n    </mat-form-field>\r\n\r\n    <div class=\"flex flex-col sm:flex-row\">\r\n      <mat-form-field class=\"flex-auto\">\r\n        <mat-label>Cliente</mat-label>\r\n        <!--<input formControlName=\"cliente\" matInput>-->\r\n        <input cdkFocusInitial formControlName=\"cliente\" type=\"text\" class=\"form-control\" id=\"cliente\" name=\"cliente\" [(ngModel)]=\"cotizaciones.cliente\" matInput>\r\n\r\n        <mat-icon [icIcon]=\"\" class=\"mr-3\" matPrefix></mat-icon>\r\n      </mat-form-field>\r\n\r\n      <mat-form-field class=\"sm:ml-6 flex-auto\">\r\n        <mat-label>Factura</mat-label>\r\n        <!--<input formControlName=\"factura\" matInput>-->\r\n        <input cdkFocusInitial formControlName=\"factura\" type=\"text\" class=\"form-control\" id=\"factura\" name=\"factura\" [(ngModel)]=\"cotizaciones.factura\" matInput>\r\n\r\n        <mat-icon [icIcon]=\"\" class=\"mr-3\" matPrefix></mat-icon>\r\n      </mat-form-field>\r\n    </div>\r\n\r\n    <div class=\"flex flex-col sm:flex-row\">\r\n      \r\n      <mat-form-field class=\"flex-auto\">\r\n        <mat-label>Forma de Pago</mat-label>\r\n        <!--<input formControlName=\"pago\" matInput>-->\r\n        <input cdkFocusInitial formControlName=\"formaPago\" type=\"text\" class=\"form-control\" id=\"formaPago\" name=\"formaPago\" [(ngModel)]=\"cotizaciones.formaPago\" matInput>\r\n\r\n        <mat-icon [icIcon]=\"\" class=\"mr-3\" matPrefix></mat-icon>\r\n      </mat-form-field>\r\n\r\n      <mat-form-field class=\"flex-auto\">\r\n        <mat-label>Pedido</mat-label>\r\n        <!--<input formControlName=\"pedido\" matInput>-->\r\n        <input cdkFocusInitial formControlName=\"pedido\" type=\"text\" class=\"form-control\" id=\"pedido\" name=\"pedido\" [(ngModel)]=\"cotizaciones.pedido\" matInput>\r\n\r\n        <mat-icon [icIcon]=\"\" class=\"mr-3\" matPrefix></mat-icon>\r\n      </mat-form-field>\r\n    </div>\r\n\r\n    <mat-form-field class=\"flex-auto\">\r\n      <mat-label>Descripción</mat-label>\r\n      <!--<textarea formControlName=\"descripcion\" matInput></textarea>-->\r\n      <input cdkFocusInitial formControlName=\"descripcion\" type=\"text\" class=\"form-control\" id=\"descripcion\" name=\"descripcion\" [(ngModel)]=\"cotizaciones.descripcion\" matInput>\r\n    </mat-form-field>\r\n  </mat-dialog-content>\r\n\r\n  <mat-dialog-actions align=\"end\">\r\n    <button mat-button mat-dialog-close type=\"button\">CANCELAR</button>\r\n    <button *ngIf=\"isCreateMode()\" color=\"primary\" mat-button type=\"submit\">CREAR COTIZACION</button>\r\n    <button *ngIf=\"isUpdateMode()\" color=\"primary\" mat-button type=\"submit\">ACTUALIZAR COTIZACION</button>\r\n  </mat-dialog-actions>\r\n</form>\r\n\r\n<mat-menu #settingsMenu=\"matMenu\" xPosition=\"before\" yPosition=\"below\">\r\n  <button mat-menu-item>\r\n    <mat-icon [icIcon]=\"icPrint\"></mat-icon>\r\n    <span>Imprimir</span>\r\n  </button>\r\n\r\n  <button mat-menu-item>\r\n    <mat-icon [icIcon]=\"icDownload\"></mat-icon>\r\n    <span>Exportar</span>\r\n  </button>\r\n\r\n  <button mat-menu-item>\r\n    <mat-icon [icIcon]=\"icDelete\"></mat-icon>\r\n    <span>Borrar</span>\r\n  </button>\r\n</mat-menu>\r\n");
...
/***/ "./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.scss":
/*!********************************************************************************************************!*\
  !*** ./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.scss ***!
  \********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL2FwcHMvY290aXphY2lvbi9jb3RpemFjaW9uLWNyZWF0ZS11cGRhdGUvY290aXphY2lvbi1jcmVhdGUtdXBkYXRlLmNvbXBvbmVudC5zY3NzIn0= */");

/***/ }),

/***/ "./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.ts":
/*!******************************************************************************************************!*\
  !*** ./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.ts ***!
  \******************************************************************************************************/
/*! exports provided: CotizacionCreateUpdateComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CotizacionCreateUpdateComponent", function() { return CotizacionCreateUpdateComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _shared_services_quotes_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../shared/services/quotes.service */ "./src/app/shared/services/quotes.service.ts");
/* harmony import */ var _shared_models_quotes__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../shared/models/quotes */ "./src/app/shared/models/quotes.ts");
...
/* harmony import */ var _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../shared/services/storage/storage.service */ "./src/app/shared/services/storage/storage.service.ts");
var CotizacionCreateUpdateComponent_1;
...
let CotizacionCreateUpdateComponent = CotizacionCreateUpdateComponent_1 = class CotizacionCreateUpdateComponent {
    constructor(defaults, dialogRef, fb, firestore, storageService, quotessService) {
        this.defaults = defaults;
        this.dialogRef = dialogRef;
        this.fb = fb;
        this.firestore = firestore;
        this.storageService = storageService;
        this.quotessService = quotessService;
        this.cotizaciones = new _shared_models_quotes__WEBPACK_IMPORTED_MODULE_15__["Quotes"]();
        this.loading = false;
        this.mode = 'create';
    ...
    ngOnInit() {
        if (this.storageService.getSession("$key") != null) {
            this.cotizaciones = this.storageService.getSession("mydata");
        }
        if (this.defaults) {
            this.mode = 'update';
        }
        ...
        this.form = this.fb.group({
            $key: newId,
            id: [CotizacionCreateUpdateComponent_1.id++],
            // imageSrc: this.defaults.imageSrc,
            producto: [this.defaults.producto || ''],
            cliente: [this.defaults.cliente || ''],
            precio: this.defaults.precio || '',
            pedido: this.defaults.pedido || '',
            factura: this.defaults.factura || '',
            descripcion: this.defaults.descripcion || '',
            //pago: this.defaults.pago || '',
            noCotizacion: this.defaults.noCotizacion || '',
            formaPago: this.defaults.formaPago || '',
        });
    }
    save(quotesForm) {
        if (this.mode === 'create') {
            this.addQuotes(quotesForm);
        }
        else if (this.mode === 'update') {
            this.updateCustomers();
        }
    }
    addQuotes(quotesForm) {
        this.quotessService.postQuotes(quotesForm.value);
        this.createCotizacion();
        alert("Cotizacion guardado");
    }
    updateCustomers() {
        if (this.storageService.getSession("$key") != null) {
            //var value = new AddEstablishment
            var values = {
                id: this.cotizaciones.id,
                producto: this.cotizaciones.producto,
                cliente: this.cotizaciones.cliente,
                pedido: this.cotizaciones.pedido,
                precio: this.cotizaciones.precio,
                factura: this.cotizaciones.factura,
                descripcion: this.cotizaciones.descripcion,
                formaPago: this.cotizaciones.formaPago,
                noCotizacion: this.cotizaciones.noCotizacion,
            };
            const Cotizacion = this.form.value;
            Cotizacion.id = String(values.id);
            Cotizacion.producto = String(values.producto);
            Cotizacion.cliente = String(values.cliente);
            Cotizacion.pedido = String(values.pedido);
            Cotizacion.precio = Number(values.precio);
            Cotizacion.factura = String(values.factura);
            Cotizacion.descripcion = String(values.descripcion);
            Cotizacion.formaPago = String(values.formaPago);
            Cotizacion.noCotizacion = Number(values.noCotizacion);
            this.quotessService.updateQuotes(values);
            this.updateCotizacion();
            console.log('print value::' + JSON.stringify(Cotizacion));
        }
        else {
    ...
    createCotizacion() {
        const cotizacion = this.form.value;
        if (!cotizacion.imageSrc) {
            cotizacion.imageSrc = 'assets/img/avatars/1.jpg';
        }
        this.dialogRef.close(cotizacion);
    }
    updateCotizacion() {
        const cotizacion = this.form.value;
        cotizacion.id = this.defaults.id;
        this.dialogRef.close(cotizacion);
    }
    isCreateMode() {
...
CotizacionCreateUpdateComponent.id = 100;
CotizacionCreateUpdateComponent.ctorParameters = () => [
    ...
    { type: _shared_services_quotes_service__WEBPACK_IMPORTED_MODULE_14__["QuotesService"] }
];
CotizacionCreateUpdateComponent = CotizacionCreateUpdateComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'vex-cotizacion-create-update',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./cotizacion-create-update.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./cotizacion-create-update.component.scss */ "./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.scss")).default]
    }),
...
], CotizacionCreateUpdateComponent);



/***/ }),

/***/ "./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.module.ts":
/*!***************************************************************************************************!*\
  !*** ./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.module.ts ***!
  \***************************************************************************************************/
/*! exports provided: CotizacionCreateUpdateModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CotizacionCreateUpdateModule", function() { return CotizacionCreateUpdateModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _cotizacion_create_update_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./cotizacion-create-update.component */ "./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.ts");
...
let CotizacionCreateUpdateModule = class CotizacionCreateUpdateModule {
};
CotizacionCreateUpdateModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        ...
        declarations: [_cotizacion_create_update_component__WEBPACK_IMPORTED_MODULE_11__["CotizacionCreateUpdateComponent"]],
        entryComponents: [_cotizacion_create_update_component__WEBPACK_IMPORTED_MODULE_11__["CotizacionCreateUpdateComponent"]],
        exports: [_cotizacion_create_update_component__WEBPACK_IMPORTED_MODULE_11__["CotizacionCreateUpdateComponent"]]
    })
], CotizacionCreateUpdateModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CotizacionRoutingModule", function() { return CotizacionRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _cotizacion_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cotizacion.component */ "./src/app/pages/apps/cotizacion/cotizacion.component.ts");
...
let CotizacionRoutingModule = class CotizacionRoutingModule {
};
CotizacionRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/*!***************************************************************!*\
  !*** ./src/app/pages/apps/cotizacion/cotizacion.component.ts ***!
  \***************************************************************/
/*! exports provided: CotizacionComponent, QuotesDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CotizacionComponent", function() { return CotizacionComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuotesDataSource", function() { return QuotesDataSource; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/cdk/collections */ "./node_modules/@angular/cdk/esm2015/collections.js");
...
/* harmony import */ var _iconify_icons_ic_twotone_folder__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @iconify/icons-ic/twotone-folder */ "./node_modules/@iconify/icons-ic/twotone-folder.js");
/* harmony import */ var _iconify_icons_ic_twotone_folder__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_folder__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony import */ var _vex_animations_stagger_animation__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../@vex/animations/stagger.animation */ "./src/@vex/animations/stagger.animation.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ngx-take-until-destroy */ "./node_modules/ngx-take-until-destroy/fesm2015/ngx-take-until-destroy.js");
/* harmony import */ var _iconify_icons_ic_twotone_phone__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @iconify/icons-ic/twotone-phone */ "./node_modules/@iconify/icons-ic/twotone-phone.js");
/* harmony import */ var _iconify_icons_ic_twotone_phone__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_phone__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _iconify_icons_ic_twotone_mail__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @iconify/icons-ic/twotone-mail */ "./node_modules/@iconify/icons-ic/twotone-mail.js");
/* harmony import */ var _iconify_icons_ic_twotone_mail__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_mail__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _iconify_icons_ic_twotone_map__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @iconify/icons-ic/twotone-map */ "./node_modules/@iconify/icons-ic/twotone-map.js");
/* harmony import */ var _iconify_icons_ic_twotone_map__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(_iconify_icons_ic_twotone_map__WEBPACK_IMPORTED_MODULE_22__);
/* harmony import */ var _cotizacion_create_update_cotizacion_create_update_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./cotizacion-create-update/cotizacion-create-update.component */ "./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.component.ts");
...
/* harmony import */ var _shared_services_storage_storage_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../../shared/services/storage/storage.service */ "./src/app/shared/services/storage/storage.service.ts");
/* harmony import */ var src_app_shared_models_quotes__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! src/app/shared/models/quotes */ "./src/app/shared/models/quotes.ts");
/* harmony import */ var src_app_shared_services_quotes_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! src/app/shared/services/quotes.service */ "./src/app/shared/services/quotes.service.ts");
...
let CotizacionComponent = class CotizacionComponent {
    constructor(dialog, quotessService, afs, storageService) {
        this.dialog = dialog;
        this.quotessService = quotessService;
        this.afs = afs;
        this.storageService = storageService;
        this.cotizaciones = new src_app_shared_models_quotes__WEBPACK_IMPORTED_MODULE_26__["Quotes"];
        this.clickDelete = this.cotizaciones.id;
        ...
        this.rowData = [];
        this.dataSource = new QuotesDataSource(this.quotessService);
    ...
    ngOnInit() {
        ...
        this.dataSource.connect().subscribe(cotizacions => {
            this.subject$.next(JSON.parse(JSON.stringify(cotizacions)));
            this.items = cotizacions;
        });
        //this.dataSource.getAllMarketing();
        //this.dataSource = new MatTableDataSource();
        this.data$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(Boolean)).subscribe(cotizacions => {
            this.cotizacions = cotizacions;
            this.dataSource.connect().toPromise = cotizacions;
        });
        this.searchCtrl.valueChanges.pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_19__["untilDestroyed"])(this)).subscribe(value => this.onFilterChange(value));
    }
    ngAfterViewInit() {
    ...
    createCotizacion() {
        this.dialog.open(_cotizacion_create_update_cotizacion_create_update_component__WEBPACK_IMPORTED_MODULE_23__["CotizacionCreateUpdateComponent"]).afterClosed().subscribe((quotes) => {
            if (quotes) {
    ...
    updateCotizacion(i) {
        ...
        this.dialog.open(_cotizacion_create_update_cotizacion_create_update_component__WEBPACK_IMPORTED_MODULE_23__["CotizacionCreateUpdateComponent"], {
            data: i
        }).afterClosed().subscribe(updatedCotizacion => {
            if (updatedCotizacion) {
                const index = this.cotizacions.findIndex((existingCotizacion) => existingCotizacion.id === updatedCotizacion.id);
                this.cotizacions[index] = new src_app_shared_models_quotes__WEBPACK_IMPORTED_MODULE_26__["Quotes"]();
                this.subject$.next(this.cotizacions);
            }
        });
    }
    removeAt(i) {
        console.log(i);
        this.quotessService.deleteQuotes(i);
        this.cotizacions.splice(this.cotizacions.findIndex((existingCotizacion) => existingCotizacion.id === i.id), 1);
    ...
    onLabelChange(change, row) {
        const index = this.cotizacions.findIndex(c => c === row);
        this.cotizacions[index].etiquetas = change.value;
        this.subject$.next(this.cotizacions);
    }
    ngOnDestroy() {
    }
...
CotizacionComponent.ctorParameters = () => [
    ...
    { type: src_app_shared_services_quotes_service__WEBPACK_IMPORTED_MODULE_27__["QuotesService"] },
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_24__["AngularFirestore"] },
...
CotizacionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'cotizacion',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./cotizacion.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/apps/cotizacion/cotizacion.component.html")).default,
        animations: [
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./cotizacion.component.scss */ "./src/app/pages/apps/cotizacion/cotizacion.component.scss")).default]
    })
], CotizacionComponent);

class QuotesDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_12__["DataSource"] {
    constructor(quotessService) {
        super();
        this.quotessService = quotessService;
    }
    /*getAllMarketing() {
    ...
    connect() {
        return this.quotessService.getQuotes(); //error
    }
    disconnect() {
    }
}
...
/* harmony import */ var _vex_components_page_layout_page_layout_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../@vex/components/page-layout/page-layout.module */ "./src/@vex/components/page-layout/page-layout.module.ts");
...
/* harmony import */ var _cotizacion_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./cotizacion.component */ "./src/app/pages/apps/cotizacion/cotizacion.component.ts");
/* harmony import */ var _cotizacion_create_update_cotizacion_create_update_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./cotizacion-create-update/cotizacion-create-update.module */ "./src/app/pages/apps/cotizacion/cotizacion-create-update/cotizacion-create-update.module.ts");
/* harmony import */ var _cotizacion_routing_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./cotizacion-routing.module */ "./src/app/pages/apps/cotizacion/cotizacion-routing.module.ts");
...
CotizacionModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_cotizacion_component__WEBPACK_IMPORTED_MODULE_20__["CotizacionComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _cotizacion_routing_module__WEBPACK_IMPORTED_MODULE_22__["CotizacionRoutingModule"],
            ...
            _cotizacion_create_update_cotizacion_create_update_module__WEBPACK_IMPORTED_MODULE_21__["CotizacionCreateUpdateModule"],
...
/***/ "./src/app/shared/models/quotes.ts":
/*!*****************************************!*\
  !*** ./src/app/shared/models/quotes.ts ***!
  \*****************************************/
...
//# sourceMappingURL=pages-apps-cotizacion-cotizacion-module-es2015.js.map
...
/* harmony import */ var _static_data_autos__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../static-data/autos */ "./src/static-data/autos.ts");
...
let ContactsGridComponent = class ContactsGridComponent {
    constructor(dialog, route) {
        ...
        this.filteredContacts$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["map"])(paramMap => paramMap.get('activeCategory')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_17__["map"])(activeCategory => {
            switch (activeCategory) {
                ...
                case 'starred': {
                    return _static_data_autos__WEBPACK_IMPORTED_MODULE_10__["autosData"].filter(c => c.starred);
                }
                default: {
                    return [];
                }
    ...
    toggleStar(id) {
        const contact = _static_data_autos__WEBPACK_IMPORTED_MODULE_10__["autosData"].find(c => c.id === id);
        if (contact) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "autosData", function() { return autosData; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

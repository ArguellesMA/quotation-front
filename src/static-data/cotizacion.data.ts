...
export const cotizacionData = [
  {
    ...
    pedido: '1231',
    factura: 'jkj12312',
    descripcion: 'compra de tostitos para oxxo, con vigencia de 20 de marzo del 2020',
    pago: 'credito',
    labels: [cotizacionLabels[0], cotizacionLabels[1]]
  },
  /*
  {
    id: 1,
  ...
  },
  {
    ...
    firstName: 'Emilio',
    lastName: 'Moreno',
    street: 'Laminadora de acero 123, Col. Mayorazgo',
    zipcode: 7894,
    city: 'Puebla',

...
const childrenRoutes: VexRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'cotizacion',
        loadChildren: () => import('./pages/apps/cotizacion/cotizacion.module').then(m => m.CotizacionModule)
      },
      {
        path: 'operators',
        loadChildren: () => import('./pages/apps/operators/operators.module').then(m => m.OperatorsModule)
      },
      {
        path: 'help-center',
